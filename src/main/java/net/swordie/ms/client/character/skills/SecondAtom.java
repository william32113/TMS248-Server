...
public class SecondAtom {
    ...
    public void encode(OutPacket outPacket) {
        ...
        outPacket.encodeInt(getDataIndex()-1);
        outPacket.encodeInt(getCharId());
        outPacket.encodeInt(getTargetID()); //Target
        outPacket.encodeInt(getCreateDel()); //Create
        outPacket.encodeInt(getEnableDel()); //EnableDelay 600
        outPacket.encodeInt(0); //Rotate (i == 2) ? 15 : ((i == 3) ? -15 : ((i == 4) ? 30 : ((i == 5) ? -30 : 0))));
        outPacket.encodeInt(getSkillId()); //skillID //151001001
        outPacket.encodeInt(getSkilllv()); //Slv
        outPacket.encodeInt(0);
        outPacket.encodeInt(getExpire()); //Expire 2400
        outPacket.encodeInt(0);
        outPacket.encodeInt(1);
        outPacket.encodeInt(0); //CustomRotate 0
        outPacket.encodeInt(getMaxAtt()); //AttAcount 0
